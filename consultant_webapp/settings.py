"""
Django settings for consultant_webapp project.
...
ALLOWED_HOSTS = ['consultant-webapp.onrender.com','*']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'custom_admin.context_processors.timesheet_sidebar_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'consultant_webapp.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv('MSSQL_DB_PASSWORD', 'Sof#tech@2025'),
        'HOST': os.getenv('MSSQL_DB_HOST', '103.16.222.51'),
...
FERNET_KEY = b'jNDSXZP-Xayam_y9Ckr9GYT2sHEdKtvwPJO_NRMjy5o='
...
EMAIL_HOST_PASSWORD = 'udhw cnrs vubw alzs'
...
LOGGING = {
    ...
    'handlers': {
        'general_file': {
            'level': 'INFO',
            'class': 'consultant_webapp.settings.SafeFileHandler',
